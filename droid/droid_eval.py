...
def main(args: Args):
    ...
    policy_client = WebClientCrossFormerPolicy(args.remote_host, args.remote_port)

    df = pd.DataFrame(columns=["success", "duration", "video_filename"])

    while True:
        instruction = input("Enter instruction: ")
        policy_client.reset(instruction)
        ...
        for t_step in bar:
            ...
            try:
                ...
                # and improve latency.
                request_data = {
                    "image_primary": resize(
                        curr_obs[f"{args.external_camera}_image"], size=(224, 224)
                    ),
                ...
                policy_client.send(request_data)
                ...
                print("gripper action:", action[-1].item())
